...
public interface ScheduleService {
    ...
    PageResult<SchedulePageResult> getScheduleList(String coursename,String starttime,String endtime,int page,int pagesize,String userid,String courseteacher);
    PageResult<List<SchedulePageResult>> getWeekScheduleList(String date,String courseteacher);
}
